...
# Biển số xe 50cc
# XX-xx / XXX.XX
# seri biển số sử dụng lần lượt một trong 20 chữ cái sau đây:
# A, B, C, D, E, F, G, H, K, L, M, N, P, S, T, U, V, X, Y, Z
# kết hợp với một trong các chữ cái sau:
...
# XX-Xn / XXX.XX
# seri biển số sử dụng một trong 19 chữ cái
# B, C, D, E, F, G, H, K, L, M, N, P, S, T, U, V, X, Y, Z
# kết hợp với một chữ số tự nhiên từ 1 đến 9
...
# Biển số xe Ô tô - tải
# XXn/nn- - XXX.XX
#  sêri biển số sử dụng lần lượt một trong 20 chữ cái sau đây:
#  A, B, C, D, E, F, G, H, K, L, M, N, P, S, T, U, V, X, Y, Z
...
pattern_general_list = [regex_electric_moto, regex_military, regex_specical, regex_powerful_moto, regex_100cc_moto,
                        regex_50cc_moto, regex_temp, regex_foreign, regex_oto]
...
def postprocess(plate, probs):
    ...
    if pattern_index == -1:
        ...
        return plate, min_prob


if __name__ == '__main__':
    # Biển số xe 50cc
    plate_test_0 = {"26AA0021": 'T', "26AA00212": 'T', "26AO00212": 'F', "26AB002125": 'F', "26AB002": 'F',
                    "6AB0021": 'F'}
